...
python3 scripts/task_state_migration_verifier.py \
  --root ROOT \
...
Relocation success proves graph integrity and verifier portability only. It does not prove semantic progress, artifact-truth completion, readiness, gold quality, canonical or production promotion, or Issue 1836 closure. Live migration apply, recover, and replay counts remain zero for verification cycles.
