...
If a hook is absent, fail quiet and keep existing schema-contract rules. Do not infer privacy classes, identifier forms, merge depth, field authority, formulas, sampled populations, or thresholds from project filenames, sample text, or domain vocabulary in this skill.
