...
def _verification_fields(state: dict[str, Any]) -> dict[str, Any]:
    (
        adapter_expected_path, adapter_registered, diagnostics_gate, domain_adapter,
        domain_adapter_error, domain_adapter_path, effective_count_key, envelope_thaw_streak,
        failure_surface_gate, input_contract_gate, prev_fingerprint, previous_adapter_high,
        previous_baseline_error, previous_baseline_source, quality, reachability_gate,
        root_dominant_parameter_key, source_separation_gate, verifier_coupling_gate,
    ) = _require_values(
        state,
        (
            'adapter_expected_path', 'adapter_registered', 'diagnostics_gate',
            'domain_adapter', 'domain_adapter_error', 'domain_adapter_path',
            'effective_count_key', 'envelope_thaw_streak', 'failure_surface_gate',
            'input_contract_gate', 'prev_fingerprint', 'previous_adapter_high',
            'previous_baseline_error', 'previous_baseline_source', 'quality',
            'reachability_gate', 'root_dominant_parameter_key', 'source_separation_gate',
