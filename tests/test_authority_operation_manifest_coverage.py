...
REQUIRED_WORKFLOW_OPERATIONS = {
    ...
    "manage-agent-authority": {
        ...
        "materialize_authority_interaction_activation",
        "materialize_authority_interaction_child",
        "materialize_plan_bound_root_grant",
        "prepare_authority_interaction_activation",
        "prepare_root_approval_plan",
        "publish_operation_set",
        "publish_authority_interaction_evidence",
    ...
    "repo-change-commit": {"finalize_git_state", "push_git_ssh"},
...
PROJECTION_ONLY_MUTATIONS = {
    ...
    ("manage-agent-authority", "prepare_authority_interaction_activation"),
    ("manage-agent-authority", "publish_authority_interaction_evidence"),
