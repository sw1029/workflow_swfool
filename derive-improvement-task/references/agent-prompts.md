...
5. List existing candidate_task files whose immutable identity/status/link should transition to `applied` or `superseded`; do not make the mutable current-selection pointer by deleting completed candidate evidence.
