...
- [Tier contract](#tier-contract)
- [Direction boundary](#direction-boundary)
- [Model binding contract](#model-binding-contract)
- [Dynamic selection](#dynamic-selection)
- [Bounded maximum and prohibited delegation](#bounded-maximum-and-prohibited-delegation)
- [Evidence contract](#evidence-contract)
- [Default phase mapping](#default-phase-mapping)

Use [model-effort-profiles.json](model-effort-profiles.json) as the executable policy and `python3 -P -m orchestrate_task_cycle model-effort` as the deterministic selector. Keep role/tier policy global and keep runtime model bindings in caller configuration or a repository adapter.
...
```bash
python3 -P -m orchestrate_task_cycle model-effort \
