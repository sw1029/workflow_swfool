...
Dashboards must surface unresolved Part L blockers or progress-axis notes when ledger events contain them: stale-lane pass, stale decision measurement, producer-starved gating axis, restrictive portfolio quota, cycle-unreachable target, basis overclaim, or surface-field defects. Keep this as a render of ledger evidence, not a new validation verdict.
