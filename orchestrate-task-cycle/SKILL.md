...
- [anti-loop-progress-gates.md](references/anti-loop-progress-gates.md): loopback progress gates, output-delta policy, gate satisfiability, terminal quiescence, terminal escalation, and no-overclaim boundaries.
