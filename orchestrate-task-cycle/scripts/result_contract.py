...
class ResultContractValidator:
    ...
    def validate(self, target: str, result: dict[str, Any], mode: str = "warn") -> dict[str, Any]:
        ...
        return _validate(target, result, mode, self.rule_registry)
...
def validate(target: str, result: dict[str, Any], mode: str) -> dict[str, Any]:
    ...
    return DEFAULT_VALIDATOR.validate(target, result, mode)
