...
def _result(
    ...
    return {
        ...
        "execution_scope_applicability": scope.execution_scope_applicability,
        "execution_scope_exclusion_reason_id": scope.execution_scope_exclusion_reason_id,
        "execution_scope_status": scope.execution_scope_status,
        "scope_evidence_required": scope.execution_scope_evidence_required,
        "required_input_binding": scope.required_input_binding,
        ...
        "recent_cycle_run_receipts": scope.recent_run_receipts,
