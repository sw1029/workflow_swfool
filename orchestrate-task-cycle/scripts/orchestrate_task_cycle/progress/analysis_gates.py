...
from .constants import DISPOSITION_UNIVERSE, REGISTRY_REL_PATH
from .dispositions import consolidation_streak, effective_allowed_dispositions
from .evidence import command_surface_budget
from .terminal import terminal_escalation_gate, terminal_quiescence_gate
from .values import boolish



class GateEvaluationCore(ContextBoundStage):
    name = "gates"
...
class GateEvaluationStage(GateEvaluationCore):
    """Evaluate root, distance, integrity, and disposition gates."""
...
class GateEvaluationMixin(GateEvaluationStage):
    """Compatibility name for the gate-evaluation stage strategy."""
