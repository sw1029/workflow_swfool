...
from ..result_contract.decision_identity_dimensions import explicit_v2_floor_declared
...
from .loopback_candidate_validation import validate_loopback_finalization_binding
...
def _validate_loopback_finalization_binding(
    ...
    validate_loopback_finalization_binding(
        root,
        normalized,
        max_packet_bytes=MAX_LOOPBACK_PACKET_BYTES,
    )
